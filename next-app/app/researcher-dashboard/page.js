    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-purple-600">
            {anonymizedData?.data_points_count || 0}
          </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-yellow-600">
            {rareConditions?.condition_count || 0}
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/research/studies" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/research/participants" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
            ...
            <div className="space-y-4">
              {participants.results.slice(0, 5).map((participant) => (
                <div key={participant.id} className="border-b pb-3">
                  ...
                  <div className="flex justify-end mt-1">
                    <Link href={`/research/participants/${participant.id}`} className="text-sm text-blue-600 hover:text-blue-800">
                      View details →
                    </Link>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/research/data" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
              ...
              {anonymizedData.datasets.slice(0, 5).map((dataset, index) => (
                <div key={index} className="border-b pb-3">
                  ...
                  <div className="flex justify-end mt-1 space-x-2">
                    <Link href={`/research/data/${dataset.id}/view`} className="text-sm bg-blue-100 hover:bg-blue-200 text-blue-800 px-2 py-1 rounded">
                      View
                    </Link>
                    <Link href={`/research/data/${dataset.id}/export`} className="text-sm bg-green-100 hover:bg-green-200 text-green-800 px-2 py-1 rounded">
                      Export
                    </Link>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/research/rare-conditions" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
            ...
            <div className="space-y-4">
              {rareConditions.results.slice(0, 5).map((condition) => (
                <div key={condition.id} className="border-b pb-3">
                  ...
                  <div className="flex justify-end mt-1">
                    <Link href={`/research/rare-conditions/${condition.id}`} className="text-sm text-blue-600 hover:text-blue-800">
                      View details →
                    </Link>
                  </div>
                </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/research/studies/new" className="bg-blue-100 hover:bg-blue-200 text-blue-800 p-4 rounded-lg text-center">
          ...
          <Link href="/research/participants/invite" className="bg-green-100 hover:bg-green-200 text-green-800 p-4 rounded-lg text-center">
            <div className="flex flex-col items-center">
              <svg className="h-8 w-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/research/data/analyze" className="bg-purple-100 hover:bg-purple-200 text-purple-800 p-4 rounded-lg text-center">
            <div className="flex flex-col items-center">
              <svg className="h-8 w-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/research/reports" className="bg-yellow-100 hover:bg-yellow-200 text-yellow-800 p-4 rounded-lg text-center">
            <div className="flex flex-col items-center">
              <svg className="h-8 w-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Access standardized research protocols and templates.
            </p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Review ethics guidelines and IRB submission templates.
            </p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Access statistical analysis tools and resources.
            </p>
