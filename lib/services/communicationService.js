...
export const communicationService = {
   ...
   */
  getForums: (params = {}) =>
    apiRequest("GET", "/communication/community/forums", null, {
      params,
  ...
  getForumById: (forumId) =>
    apiRequest("GET", `/communication/community/forums/${forumId}`, null, {
   ...
   */
  getThreads: (params = {}) =>
    apiRequest("GET", "/communication/community/threads", null, {
      params,
  ...
  getThreadById: (threadId) =>
    apiRequest("GET", `/communication/community/threads/${threadId}`, null, {
  ...
  createThread: (threadData) =>
    apiRequest("POST", "/communication/community/threads", threadData, {
  ...
  getPosts: (threadId, params = {}) =>
    apiRequest("GET", `/communication/community/threads/${threadId}/posts`, null, {
      params,
  ...
  createPost: (threadId, postData) =>
    apiRequest("POST", `/communication/community/threads/${threadId}/posts`, postData, {
   ...
   */
  getPostById: (postId) =>
    apiRequest("GET", `/communication/community/posts/${postId}`, null, {
  ...
  updatePost: (postId, postData) =>
    apiRequest("PUT", `/communication/community/posts/${postId}`, postData, {
   ...
   */
  deletePost: (postId) =>
    apiRequest("DELETE", `/communication/community/posts/${postId}`, null, {
  ...
  getModerationQueue: (params = {}) =>
    apiRequest("GET", "/communication/community/moderation/queue", null, {
      params,
  ...
  approveModerationItem: (itemId) =>
    apiRequest("POST", `/communication/community/moderation/items/${itemId}/approve`, null, {
  ...
  rejectModerationItem: (itemId, rejectionData) =>
    apiRequest("POST", `/communication/community/moderation/items/${itemId}/reject`, rejectionData, {
  ...
  getConversations: (params = {}) =>
    apiRequest("GET", "/communication/conversations", null, {
      params,
  ...
  getConversationById: (conversationId) =>
    apiRequest("GET", `/communication/conversations/${conversationId}`, null, {
  ...
  createConversation: (conversationData) =>
    apiRequest("POST", "/communication/conversations", conversationData, {
  ...
  getConversationMessages: (conversationId, params = {}) =>
    apiRequest("GET", `/communication/conversations/${conversationId}/messages`, null, {
      params,
  ...
  sendMessageInConversation: (conversationId, messageData) =>
    apiRequest("POST", `/communication/conversations/${conversationId}/messages`, messageData, {
  ...
  getMessageById: (messageId) =>
    apiRequest("GET", `/communication/messages/${messageId}`, null, {
  ...
  updateMessage: (messageId, messageData) =>
    apiRequest("PUT", `/communication/messages/${messageId}`, messageData, {
  ...
  deleteMessage: (messageId) =>
    apiRequest("DELETE", `/communication/messages/${messageId}`, null, {
