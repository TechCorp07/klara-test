...
export const ehrService = {
   ...
   */
  searchPatients: (searchParams) => healthcare.getUserList({ ...searchParams, role: "patient" }), // Mapped to GET /users/users
   ...
   */
  getPatientMedications: (patientId) => medicationService.getMedications({ patient_id: patientId }), // Mapped to GET /medication/medications
   ...
   */
  createMedication: (medicationData) => medicationService.createMedication(medicationData), // Use updated medication service
