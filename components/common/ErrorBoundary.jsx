    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4" role="alert" aria-live="assertive">
        <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="mb-4 text-gray-600">We've encountered an unexpected error. Our team has been notified.</p>
          ...
          {process.env.NODE_ENV !== "production" && error && (
            <div className="mt-6 p-4 bg-red-50 rounded text-left">
              ...
              <p className="text-sm text-red-700 mb-2">{error.toString()}</p>
              {this.state.errorInfo && (
                <details className="text-xs">
                  <summary className="cursor-pointer text-red-700 mb-1">Component Stack</summary>
                  <pre className="overflow-auto p-2 bg-red-100 rounded">{this.state.errorInfo.componentStack}</pre>
                </details>
              )}
            </div>
          )}
