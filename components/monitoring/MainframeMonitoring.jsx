  ...
  function generateRandomHistory(points, min, max, isInteger = false) {
    ...
    for (let i = 0; i < points; i++) {
      ...
      history.push({
        ...
        value: isInteger ? Math.round(value) : Number.parseFloat(value.toFixed(1)),
      })
    }
    return history
  }
    ...
    <div className="mainframe-monitoring">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex align-items-center">
          {lastRefreshed && (
            <small className="text-muted me-3">Last updated: {lastRefreshed.toLocaleTimeString()}</small>
          )}
      ...
      <div className="row mb-4">
        <div className="col-md-6">
          <div className="input-group">
            <label className="input-group-text" htmlFor="systemSelect">
              System
            </label>
            <select className="form-select" id="systemSelect" value={selectedSystem} onChange={handleSystemChange}>
              ...
              <div className="mt-4">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div>
                    ...
                    <span className="badge bg-danger">{monitoringData.metrics.transactions.failed} Failed</span>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  {job.status === "running" && (
                    <div className="mt-2">
                      ...
                      <div className="d-flex justify-content-between mt-1">
                        <small className="text-muted">Started: {new Date(job.startTime).toLocaleTimeString()}</small>
