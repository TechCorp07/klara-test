    ...
    return (
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          ...
          <span className="text-lg font-bold text-gray-800">{format(currentMonth, dateFormat)}</span>
        </div>
          ...
          >
            ...
            <div className="space-y-1">
              ...
              {dayAppointments.length > 3 && (
                <div className="text-xs text-gray-500 pl-1">+ {dayAppointments.length - 3} more</div>
              )}
            </div>
          </div>,
        )
          ...
          <div className="divide-y divide-gray-100">
            {dayAppointments.length > 0 ? (
              dayAppointments.map((appointment) => (
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-1 h-10 rounded-full mr-3 ${getAppointmentStatusColor(appointment.status)}`} />
                    <div className="flex-1">
                      <div className="flex justify-between">
                        <p className="font-medium text-sm">{format(parseISO(appointment.scheduled_time), "h:mm a")}</p>
                        <p className="text-xs text-gray-500">{getAppointmentTypeLabel(appointment.appointment_type)}</p>
                      </div>
              ...
              <div className="p-4 text-center text-sm text-gray-500">No appointments scheduled</div>
            )}
          </div>
        </div>,
      )
