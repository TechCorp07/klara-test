...
const PredictiveAnalytics = ({
  ...
  const renderResourcesPredictions = () => {
    ...
    const equipmentUtilization = Math.round(
      (resources.predicted.equipment.needed / resources.current.equipment.total) * 100,
    )
        ...
        <div className="card-body">
          <div className="row mb-4">
            <div className="col-md-6">
              ...
              <p className="text-muted">
                <small>
                  Predicted: {resources.predicted.beds.needed} of {resources.current.beds.total} beds needed
                </small>
              </p>
            </div>
            <div className="col-md-6">
              ...
              <p className="text-muted">
                <small>
                  Predicted: {resources.predicted.equipment.needed} of {resources.current.equipment.total} equipment
                  items needed
                </small>
              </p>
            </div>
              ...
              <tbody>
                {staffing.recommendations.map((rec, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span
                        className={`badge bg-${rec.priority === "high" ? "danger" : rec.priority === "medium" ? "warning" : "info"}`}
                      >
                        {rec.priority}
                      </span>
                    </td>
