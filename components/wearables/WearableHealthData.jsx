    ...
    <div className="wearable-health-data">
      ...
      <div className="metrics-selector mb-4">
        ...
        <div className="form-check form-check-inline">
          ...
          />
          <label className="form-check-label" htmlFor="heartRateCheck">
            Heart Rate
          </label>
        </div>
        <div className="form-check form-check-inline">
          ...
          />
          <label className="form-check-label" htmlFor="stepsCheck">
            Steps
          </label>
        </div>
        <div className="form-check form-check-inline">
          ...
          />
          <label className="form-check-label" htmlFor="sleepCheck">
            Sleep
          </label>
        </div>
        <div className="form-check form-check-inline">
          ...
          />
          <label className="form-check-label" htmlFor="bloodPressureCheck">
            Blood Pressure
          </label>
        </div>
        <div className="form-check form-check-inline">
          ...
          />
          <label className="form-check-label" htmlFor="bloodGlucoseCheck">
            Blood Glucose
          </label>
        </div>
      </div>
                    ...
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.min(
                            ...healthData
                              .filter((data) => data.heartRate?.min > 0)
                              .map((data) => data.heartRate?.min || 999),
                          )}{" "}
                          bpm
                        </p>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.round(
                            healthData.reduce((sum, data) => sum + (data.sleep?.duration || 0), 0) /
                              healthData.length /
                              60,
                          )}{" "}
                          hrs
                    ...
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.round(
                            healthData.reduce((sum, data) => sum + (data.sleep?.deepSleep || 0), 0) /
                              healthData.length /
                              60,
                          )}{" "}
                          hrs
                    ...
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.round(
                            healthData.reduce((sum, data) => sum + (data.sleep?.quality || 0), 0) / healthData.length,
                          )}
                          %
                        </p>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.round(
                            healthData.reduce((sum, data) => sum + (data.bloodGlucose?.value || 0), 0) /
                              healthData.filter((data) => data.bloodGlucose).length,
                          )}{" "}
                          mg/dL
                        </p>
                      </div>
                    ...
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.max(
                            ...healthData
                              .filter((data) => data.bloodGlucose)
                              .map((data) => data.bloodGlucose?.value || 0),
                          )}{" "}
                          mg/dL
                        </p>
                      </div>
                    ...
                    <div className="col-md-4">
                      <div className="metric-card text-center p-3 border rounded">
                        ...
                        <p className="h3">
                          {Math.min(
                            ...healthData
                              .filter((data) => data.bloodGlucose && data.bloodGlucose.value > 0)
                              .map((data) => data.bloodGlucose?.value || 999),
                          )}{" "}
                          mg/dL
                        </p>
                      </div>
                    ...
                    <tbody>
                      {analysis.medicationImpacts.map((impact, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            <span
                              className={`badge ${impact.status === "Good" ? "bg-success" : impact.status === "Moderate" ? "bg-warning" : "bg-danger"}`}
                            >
                              {impact.status}
                            </span>
                          </td>
