    ...
    <div className="fhir-export card">
      ...
      <div className="card-body">
        <form onSubmit={handleExport}>
          <div className="mb-3">
            <label htmlFor="exportType" className="form-label">
              Export Type
            </label>
            <select
              id="exportType"
          ...
          <div className="mb-3">
            <label htmlFor="_since" className="form-label">
              Since Date (Optional)
            </label>
            <input
              type="datetime-local"
          ...
          <div className="mb-3">
            <label htmlFor="_elements" className="form-label">
              Elements (Optional)
            </label>
            <input
              type="text"
        ...
        {exportStatus && (
          <div className="mt-4">
            ...
            {exportStatus === "initiating" && <div className="alert alert-info">Initiating export...</div>}
            ...
            {exportStatus === "failed" && (
              <div className="alert alert-danger">Export failed. Please try again or contact support.</div>
            )}
          </div>
        )}
      </div>
