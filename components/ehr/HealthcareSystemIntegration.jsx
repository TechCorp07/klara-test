    ...
    try {
      ...
      if (systemType) {
        filteredIntegrations = filteredIntegrations.filter(
          integration => integration.type === systemType
        );
      }
    ...
    setIntegrations(prevIntegrations => 
      prevIntegrations.map(integration => 
        integration.id === integrationId
          ? { ...integration, status: 'connected', error: null }
          : integration
      )
    );
        ...
        {integrations.map((integration) => (
          <div key={integration.id} className="col-md-6 col-lg-4 mb-4">
            <div className={`card h-100 ${integration.status === 'error' ? 'border-danger' : ''}`}>
              <div className={`card-header d-flex justify-content-between align-items-center ${integration.status === 'error' ? 'bg-danger text-white' : ''}`}>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form onSubmit={handleConfigSubmit}>
                  <div className="mb-3">
                    <label htmlFor="connectionType" className="form-label">System Type</label>
                    <select
                      id="connectionType"
                      name="connectionType"
