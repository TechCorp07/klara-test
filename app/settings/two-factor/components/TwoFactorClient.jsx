    ...
    <div className="auth-form-container">
      <div className="auth-form">
        <div className="flex flex-col items-center">
          ...
          <p className="auth-form-subtitle">Enhance your account security with two-factor authentication</p>
        </div>
          ...
          {setupStep === "initial" && !isSetupComplete && (
            <div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <button type="button" onClick={handleStartSetup} disabled={isLoading} className="auth-form-button">
                  {isLoading ? (
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-green-700">
                    <p>
                      Your account is now protected with two-factor authentication. You'll need to enter a verification
