...
import { FaUserShield, FaExclamationTriangle, FaSave, FaEye, FaShare, FaLock, FaInfoCircle } from "react-icons/fa"
            ...
            >
              <span
                className={`dot absolute left-1 top-1 h-4 w-4 rounded-full transition-transform duration-200 ease-in ${
                  value ? "transform translate-x-4 bg-blue-600" : "bg-white"
                }`}
              ></span>
            </label>
          </div>
  ...
  return (
    <AuthenticatedLayout>
      <div className="container mx-auto px-4 py-6">
        ...
        <HIPAABanner
          type="security"
          message="Your privacy is protected under HIPAA regulations. Changes to privacy settings are logged for security and compliance purposes."
        />
        ...
        <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <label htmlFor="visibility-public" className="ml-3">
                      ...
                      <span className="block text-sm text-gray-500">
                        Your profile is visible to all users of the platform
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="visibility-limited" className="ml-3">
                      ...
                      <span className="block text-sm text-gray-500">
                        Your profile is only visible to your healthcare providers and administrators
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="visibility-private" className="ml-3">
                      ...
                      <span className="block text-sm text-gray-500">
                        Your profile is only visible to your assigned healthcare provider
                      </span>
                    </label>
                  </div>
                </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Control how your health data is shared with providers and services
              </p>
            </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-blue-700">
                        <p>
                          For more information about how we collect, use, and protect your health information, please
                          see our{" "}
