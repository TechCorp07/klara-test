...
/**
 * Client component for community topics page
 */
  ...
  if (isLoading) {
    return (
      <div className="dashboard-card">
        <h1 className="dashboard-title">Community Topics</h1>
  ...
  return (
    <div className="dashboard-card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Topics List */}
        <div>
          <h2 className="dashboard-subtitle">Browse Topics</h2>
              ...
              {topics.results.map((topic) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-xs px-2 py-1 bg-muted rounded-full">{topic.post_count} posts</span>
                  </div>
          ...
          {selectedTopic ? (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h2 className="dashboard-subtitle">{selectedTopic.name} Posts</h2>
                <Link
                ...
                <div className="space-y-4">
                  {topicPosts.results.slice(0, 5).map((post) => (
                    <Link
                      ...
                      className="block p-4 rounded-lg bg-muted/30 hover:bg-muted/50 border border-border"
                    >
            ...
            <div className="flex items-center justify-center h-full min-h-[200px] bg-muted/20 rounded-lg border border-dashed border-muted p-8">
              <p className="text-muted-foreground">Select a topic to view related posts.</p>
            </div>
          )}
        </div>
      </div>
