          ...
          setDiscussions([
            {
              ...
              content:
                "I've been diagnosed with hypertension recently and I'm looking for advice on dietary changes and exercise routines that have worked for others. My doctor recommended reducing sodium intake and regular cardio, but I'd love to hear personal experiences.",
              likes: 15,
              comments: 8,
            ...
            },
            {
              ...
              content:
                "I wanted to share some promising research on new treatments for Type 2 Diabetes. A recent study published in the Journal of Endocrinology showed significant improvements in glucose control with a combination therapy approach. Has anyone had experience with the newer GLP-1 receptor agonists?",
              likes: 27,
              comments: 12,
            ...
            },
            {
              ...
              content:
                "Living with chronic pain can be isolating and frustrating. I've been dealing with fibromyalgia for 5 years now, and I've found that having a support network makes a huge difference. This thread is for sharing coping strategies, treatment experiences, and just being there for each other. What helps you on your difficult days?",
              likes: 42,
              comments: 23,
          ...
          setSupportGroups([
            {
              ...
              description:
                "Support group for individuals managing diabetes, sharing experiences, tips, and encouragement.",
              members: 156,
            ...
            },
            {
              ...
              description:
                "A community for those with heart conditions to share recovery journeys, lifestyle changes, and support.",
              members: 203,
            ...
            },
            {
              ...
              description:
                "Support network for patients with rare diseases to connect, share resources, and advocate together.",
              members: 98,
          ...
          setResources([
            {
              ...
              description:
                "Comprehensive guide to understanding medication labels, potential side effects, and important questions to ask your healthcare provider.",
              downloads: 342,
            ...
            },
            {
              ...
              description:
                "Nutritional guidelines and meal planning strategies for managing various chronic health conditions through diet.",
              downloads: 518,
            ...
            },
            {
              ...
              description:
                "Video series demonstrating effective stress management techniques including deep breathing, progressive muscle relaxation, and mindfulness practices.",
              views: 876,
              duration: "45:30",
            ...
            },
            {
              ...
              description:
                "Guide to understanding patient rights, navigating insurance, and advocating for yourself in healthcare settings.",
              downloads: 267,
        ...
        <div className="bg-white shadow sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-2 max-w-xl text-sm text-gray-500">
              <p>
                To participate in the community, you need to provide consent for sharing your information with other
                community members. Your privacy is important to us.
              </p>
            </div>
            <div className="mt-5">
              <button
                  ...
                  <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                    ...
                    <div className="mt-2 flex items-center text-sm text-gray-500">
                      <div className="flex-shrink-0 h-8 w-8 rounded-full bg-primary-100 flex items-center justify-center mr-2">
                        <span className="text-primary-800 font-medium">{discussion.author.name.charAt(0)}</span>
                      </div>
                      <span>
                      ...
                      {group.moderators.map((moderator) => (
                        <li key={moderator.id} className="flex items-center">
                          <div className="flex-shrink-0 h-6 w-6 rounded-full bg-primary-100 flex items-center justify-center">
                            <span className="text-primary-800 font-medium text-xs">{moderator.name.charAt(0)}</span>
                          </div>
                  ...
                  <li key={resource.id} className="px-4 py-4 sm:px-6">
                    ...
                    <div className="mt-2 text-xs text-gray-500">
                      {resource.type === "pdf" ? (
                        ...
                        <span>
                          {resource.views} views • {resource.duration} minutes
                        </span>
                      )}
                    </div>
                  </li>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="px-4 py-5 sm:p-6">
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Community Guidelines</label>
      ...
      <div className="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div className="px-4 py-5 sm:p-6">
          <div className="prose prose-sm max-w-none text-gray-500">
            <p>
              The Community is a safe space for patients, caregivers, and healthcare providers to connect, share
              experiences, and support each other. To maintain a positive and helpful environment, please follow these
              guidelines:
            </p>
            <h4 className="text-gray-900 font-medium mt-4">Respect Privacy</h4>
            <p>
              While sharing experiences is encouraged, please respect your own privacy and that of others. Do not share
              personally identifiable information such as full names, addresses, phone numbers, or other sensitive
              details.
            </p>
            <h4 className="text-gray-900 font-medium mt-4">Be Supportive and Respectful</h4>
            <p>
              Treat all community members with respect and empathy. Everyone's health journey is unique, and our
              community thrives when we support each other through challenges and celebrate successes together.
            </p>
            <h4 className="text-gray-900 font-medium mt-4">Medical Information</h4>
            <p>
              Information shared in the community should not replace professional medical advice. Always consult with
              your healthcare provider before making changes to your treatment plan based on information shared in the
              community.
            </p>
            <h4 className="text-gray-900 font-medium mt-4">Reporting Concerns</h4>
            <p>
              If you encounter content that violates these guidelines or makes you uncomfortable, please report it to
              our moderation team. We are committed to maintaining a safe and supportive environment for all members.
            </p>
          </div>
        </div>
      </div>
