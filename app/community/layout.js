    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="w-full md:w-auto mt-4 md:mt-0">
            <form onSubmit={handleSearch} className="flex">
              <input
                ...
                className="flex-1 min-w-0 block w-full px-3 py-2 rounded-l-md border border-gray-300 shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
              />
              <button
                type="submit"
        ...
        <nav className="flex flex-wrap space-x-1 md:space-x-4">
          ...
          <Link href="/community/topics" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
            Topics
          </Link>
          <Link href="/community/popular" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
            Popular
          </Link>
          <Link href="/community/recent" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
            Recent
          </Link>
          {hasModPermissions && (
            <Link href="/community/moderation" className="px-3 py-2 rounded-md text-sm font-medium text-red-600 hover:bg-red-50">
              Moderation
            </Link>
          )}
        </nav>
        ...
        <div className="lg:col-span-1">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="space-y-2">
              <Link href="/community/topics/general" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                General Discussion
              </Link>
              <Link href="/community/topics/research" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                Research & Studies
              </Link>
              <Link href="/community/topics/support" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                Support Groups
              </Link>
              <Link href="/community/topics/questions" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                Questions & Answers
              </Link>
              <Link href="/community/topics/rare-conditions" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                Rare Conditions
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-4">
              <Link href="/community/guidelines" className="text-primary-600 hover:text-primary-800 text-sm font-medium">
