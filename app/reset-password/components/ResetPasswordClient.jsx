          ...
          <div className="mt-8 rounded-md bg-yellow-50 p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-4">
                  <Link href="/forgot-password" className="auth-form-button inline-block text-center py-2 px-4">
                    Request new link
                  </Link>
                </div>
              </div>
            ...
            <div className="rounded-md bg-green-50 p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-4">
                    <Link href="/login" className="auth-form-button inline-block text-center py-2 px-4">
                      Go to Login
                    </Link>
                  </div>
                </div>
