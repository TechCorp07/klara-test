...
export default function NotificationsClient() {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      default:
        return (
          <svg className="h-6 w-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <>
          {/* Connection Status */}
          <div className={`mb-4 px-4 py-2 rounded-md flex items-center ${isConnected ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
          ...
          <div className="bg-white rounded-lg shadow mb-6">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex flex-wrap items-center justify-between">
              <div className="flex space-x-4 overflow-x-auto pb-2 sm:pb-0">
                ...
                >
                  Unread {unreadCount > 0 && <span className="ml-1 bg-primary-500 text-white px-2 py-0.5 rounded-full text-xs">{unreadCount}</span>}
                </button>
                <button
                  className={`px-3 py-2 text-sm font-medium rounded-md ${
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <input
                          ...
                          defaultChecked
                        />
                        <label htmlFor="appointment-notifications" className="ml-3 block text-sm font-medium text-gray-700">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <input
                          ...
                          defaultChecked
                        />
                        <label htmlFor="medication-notifications" className="ml-3 block text-sm font-medium text-gray-700">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <input
                          ...
                          defaultChecked
                        />
                        <label htmlFor="community-notifications" className="ml-3 block text-sm font-medium text-gray-700">
                          Community Activity
                        </label>
                      </div>
