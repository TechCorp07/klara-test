        ...
        <div>
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="space-y-3">
              ...
              />
              <QuickActionButton label="Message Provider" icon="comment-medical" href="/patient/messages/new" />
              <QuickActionButton
                label="Request Refill"
                icon="prescription-bottle-alt"
                href="/patient/medications/refill"
              />
              <QuickActionButton label="View Medical Records" icon="file-medical" href="/patient/medical-records" />
              <QuickActionButton label="Update Health Profile" icon="user-edit" href="/patient/profile" />
            </div>
          </div>

          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4">Community</h2>
            <p className="text-gray-600 mb-4">Connect with others who share similar health experiences.</p>
