...
const WEARABLE_TYPES = [
  { id: 'fitbit', name: 'Fitbit', logo: '/images/wearables/fitbit.png', description: 'Connect your Fitbit device to track steps, heart rate, sleep, and more.', oauth: true },
  { id: 'apple_health', name: 'Apple Health', logo: '/images/wearables/apple-health.png', description: 'Sync data from your Apple Watch and Apple Health app. Requires iPhone app.', mobileOnly: true },
  { id: 'garmin', name: 'Garmin', logo: '/images/wearables/garmin.png', description: 'Connect your Garmin device to track activities, heart rate, and sleep.', oauth: true },
  { id: 'samsung_health', name: 'Samsung Health', logo: '/images/wearables/samsung-health.png', description: 'Sync data from your Samsung Galaxy Watch and Samsung Health app. Requires Android app.', mobileOnly: true },
  { id: 'withings', name: 'Withings', logo: '/images/wearables/withings.png', description: 'Connect your Withings devices for weight, blood pressure, and activity tracking.', oauth: true },
  { id: 'google_fit', name: 'Google Fit', logo: '/images/wearables/google-fit.png', description: 'Sync data from Google Fit and compatible devices.', oauth: true },
  { id: 'oura', name: 'Oura Ring', logo: '/images/wearables/oura.png', description: 'Connect your Oura Ring to track sleep, readiness, and activity.', oauth: true },
  { id: 'whoop', name: 'WHOOP', logo: '/images/wearables/whoop.png', description: 'Connect your WHOOP strap to track recovery, strain, and sleep.', oauth: true }
];
...
export default function HealthTrackingClient() {
  ...
  const { data: deviceData, isLoading: isDataLoading } = useQuery({
    ...
    queryFn: () => wearablesService.getWearableData(
      user?.id,
        ...
        {withingsProfile && (
          <IntegrationCard 
            ...
            onDisconnect={() => handleDisconnectDevice(
              devices?.results.find(d => d.integration_type === 'withings')?.id
            )}
          />
        )}
        
        {/* Map other common integrations */}
        {devices?.results?.filter(d => d.integration_type !== 'withings').slice(0, withingsProfile ? 2 : 3).map(device => (
          <IntegrationCard
            key={device.id}
