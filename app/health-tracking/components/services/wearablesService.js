...
const fetchWithAuth = async (url, options = {}) => {
  ...
  export const wearables = {
    ...
    getWearableDevices: async (userId) => {
      return fetchWithAuth(`/api/wearables/integrations/`);
    },
    ...
    getWearableData: async (userId, dataType, startDate, endDate) => {
      ...
      return fetchWithAuth(`/api/wearables/measurements/?${params}`);
    },
    ...
    getWithingsProfile: async () => {
      const integrations = await fetchWithAuth(`/api/wearables/integrations/`);
    ...
    connectWithings: async () => {
      const connectInfo = await fetchWithAuth(`/api/wearables/connect/`);
    ...
    fetchWithingsData: async (startDate, endDate) => {
      ...
      return fetchWithAuth(`/api/wearables/sync/`, {
        method: 'POST',
        headers: {
    ...
    disconnectDevice: async (integrationId) => {
      return fetchWithAuth(`/api/wearables/integrations/${integrationId}/`, {
        method: 'DELETE'
      });
    },
    ...
    handleOAuthCallback: async (integrationType, code, redirectUri) => {
      return fetchWithAuth(`/api/wearables/callback/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    syncAppleHealthData: async (measurements) => {
      return fetchWithAuth(`/api/wearables/mobile/apple_health/sync/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    syncSamsungHealthData: async (measurements) => {
      return fetchWithAuth(`/api/wearables/mobile/samsung_health/sync/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
