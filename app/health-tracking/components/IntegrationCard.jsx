...
export default function IntegrationCard({ name, type, status, connectedAt, lastSync, onSync, onDisconnect }) {
        ...
        <div className="flex items-center">
          ...
          <div className="ml-3">
            ...
            <div className="flex items-center mt-1">
              <div
                className={`w-2 h-2 ${status === "active" ? "bg-green-500" : "bg-yellow-500"} rounded-full mr-2`}
              ></div>
