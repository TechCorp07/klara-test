    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/superadmin/organizations" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
              ...
              {orgStats.organizations.slice(0, 5).map((org, index) => (
                <div key={index} className="border-b pb-3">
                  ...
                  <div className="flex justify-end mt-1">
                    <Link href={`/superadmin/organizations/${org.id}`} className="text-sm text-blue-600 hover:text-blue-800">
                      Manage →
                    </Link>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/superadmin/admins" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
            ...
            <div className="space-y-4">
              {adminUsers.results.slice(0, 5).map((admin) => (
                <div key={admin.id} className="border-b pb-3">
                  ...
                  <p className="text-sm text-gray-600">Last Login: {admin.last_login ? new Date(admin.last_login).toLocaleString() : 'Never'}</p>
                </div>
              ))}
            </div>
          ) : (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/superadmin/alerts" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/superadmin/system" className="text-blue-600 hover:text-blue-800 text-sm">View details</Link>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/superadmin/organizations/new" className="bg-blue-100 hover:bg-blue-200 text-blue-800 p-4 rounded-lg text-center">
          ...
          <Link href="/superadmin/admins/new" className="bg-green-100 hover:bg-green-200 text-green-800 p-4 rounded-lg text-center">
            <div className="flex flex-col items-center">
              <svg className="h-8 w-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/superadmin/system/maintenance" className="bg-purple-100 hover:bg-purple-200 text-purple-800 p-4 rounded-lg text-center">
            <div className="flex flex-col items-center">
              <svg className="h-8 w-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/superadmin/system/backup" className="bg-yellow-100 hover:bg-yellow-200 text-yellow-800 p-4 rounded-lg text-center">
            <div className="flex flex-col items-center">
              <svg className="h-8 w-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/superadmin/configuration" className="text-blue-600 hover:text-blue-800 text-sm">View all</Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Configure API settings, rate limits, and integrations.
            </p>
