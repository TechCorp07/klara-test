            ...
            <div className="border-t border-gray-200">
              <dl>
                ...
                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {formatDate(medicalRecord.date_of_birth)}
                  </dd>
                </div>
                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {medicalRecord.primary_physician}
                  </dd>
                </div>
                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">Emergency Contact</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {medicalRecord.emergency_contact_name} ({medicalRecord.emergency_contact_relationship}) -{" "}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {conditions.map((condition) => (
                  <tr key={condition.id}>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">{condition.notes}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {medications.map((medication) => (
                  <tr key={medication.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{medication.prescribed_by}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {medication.refills_remaining} remaining
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button className="text-primary-600 hover:text-primary-900 mr-4">Request Refill</button>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {allergies.map((allergy) => (
                  <tr key={allergy.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{allergy.reaction}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          allergy.severity === "severe"
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">{allergy.notes}</td>
                  </tr>
                ))}
              </tbody>
            </table>
