          ...
          >
            ...
            <div className="mt-1 overflow-y-auto max-h-24">
              ...
              {dayAppointments.length > 3 && (
                <div className="text-xs text-blue-600">+ {dayAppointments.length - 3} more</div>
              )}
            </div>
          </div>,
        )
      ...
      days.push(
        <div key={i} className="flex-1 min-w-0 border-r border-gray-200 last:border-r-0">
          ...
          <div className="px-1 py-2 space-y-1 h-96 overflow-y-auto">
            {dayAppointments.length === 0 ? (
              <div className="text-center text-sm text-gray-400 mt-4">No appointments</div>
            ) : (
              dayAppointments.map((appointment) => (
                ...
                >
                  <div className="font-medium">{format(parseISO(appointment.scheduled_time), "h:mm a")}</div>
                  ...
                  <div className="flex mt-1 justify-between items-center">
                    {appointment.status === "confirmed" ? (
                      ...
                      <span className="text-xs px-1.5 py-0.5 bg-blue-100 text-blue-800 rounded">Scheduled</span>
                    )}
                  </div>
                </div>
              ))
