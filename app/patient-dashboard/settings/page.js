...
import { FaLock, FaMobileAlt, FaShieldAlt } from "react-icons/fa"
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Review your recent login activity for security purposes.</p>
                  <Link
