    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">{prescriptions?.pending_count || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-yellow-600">{inventory?.low_stock_count || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-red-600">{interactions?.total_count || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-green-600">{adherenceData?.average_adherence_rate || 0}%</p>
                ...
                .map((item) => (
                  <div key={item.id} className="border-b pb-3">
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${
                          item.stock_level === "critical" ? "bg-red-100 text-red-800" : "bg-yellow-100 text-yellow-800"
                        }`}
                      >
            ...
            <div className="space-y-4">
              {interactions.results.slice(0, 5).map((interaction) => (
                <div key={interaction.id} className="border-b pb-3">
                  ...
                  <p className="text-sm text-gray-600">
                    <span className="font-medium">Interaction:</span> {interaction.medication_1} +{" "}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">Access comprehensive drug information and references.</p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">View updated clinical guidelines and protocols.</p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">Access continuing education resources and courses.</p>
