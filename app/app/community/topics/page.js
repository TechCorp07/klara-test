    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {topics?.results && topics.results.length > 0 ? (
              ...
              {topics.results.map((topic) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-xs px-2 py-1 bg-gray-200 rounded-full">{topic.post_count} posts</span>
                  </div>
        ...
        <div>
          {selectedTopic ? (
            <div>
              ...
              ) : topicPosts?.results && topicPosts.results.length > 0 ? (
                <div className="space-y-4">
