...
import { FaDownload, FaShieldAlt, FaExclamationTriangle, FaInfoCircle, FaFileAlt, FaFileMedical, FaCalendarAlt, FaComments, FaUserCircle } from 'react-icons/fa';
...
export default function DataExportPage() {
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      toast.success('Data export request submitted successfully. You will receive an email when your data is ready to download.');
    } catch (error) {
  ...
  const getDataTypeName = (dataType) => {
    switch (dataType) {
      ...
      case 'lab_results':
        return 'Lab Results';
      default:
        return dataType.split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
    }
  };
  ...
  return (
    <AuthenticatedLayout>
      <div className="container mx-auto px-4 py-6">
        ...
        <HIPAABanner type="security" message="Download a copy of your personal health information. All export requests are securely processed and logged for compliance purposes." />
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="p-6">
              <div className="text-sm text-gray-600 space-y-4">
                <p>
                  Your exported data contains personal health information and should be handled with care.
                ...
                <p>
                  In accordance with HIPAA regulations, all data export requests and downloads are logged.
                  If you believe your account has been compromised, please contact support immediately.
                </p>
              </div>
            </div>
          </div>
