    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-yellow-600">{pendingApprovals?.total_count || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-red-600">{systemAlerts?.total_count || 0}</p>
                ...
                <div key={approval.id} className="border-b pb-3">
                  <div className="flex justify-between">
                    <p className="font-medium">
                      {approval.type.charAt(0).toUpperCase() + approval.type.slice(1)} Approval
                    </p>
                    <span
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/admin/resources" className="text-blue-600 hover:text-blue-800 text-sm">
            View all
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">Manage users, roles, and permissions.</p>
            <Link href="/admin/users" className="text-blue-600 hover:text-blue-800 text-sm">
              Manage users →
            </Link>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">View system logs and audit trails.</p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">Configure system settings and preferences.</p>
