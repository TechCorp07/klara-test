    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">{appointments?.today_count || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">{messages?.unread_count || 0}</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">{referrals?.pending_count || 0}</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">Access the latest clinical research and studies.</p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">View updated treatment protocols and guidelines.</p>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-2">Access the rare condition database and registry.</p>
