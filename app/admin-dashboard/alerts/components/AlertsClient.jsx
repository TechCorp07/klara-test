...
/**
 * Client component for alerts page with enhanced functionality
...
export default function AlertsClient() {
  ...
  // Fetch system alerts with filters using React Query
  const {
    data: alerts,
    isLoading,
    error,
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">{alerts.results.length > 0 ? 1 : 0}</span> to{" "}
                  <span className="font-medium">{alerts.results.length}</span> of{" "}
